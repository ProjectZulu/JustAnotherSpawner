...
import jas.legacy.proxy.CommonProxy;
import jas.legacy.spawner.ChunkSpawner;
import jas.legacy.spawner.SpawnerTicker;
import jas.legacy.spawner.biome.structure.StructureInterpreterHelper;
...
public class LegacyJustAnotherSpawner {

    @Instance(DefaultProps.MODID)
    public static LegacyJustAnotherSpawner modInstance;
