...
public class LivingHandler {
	...
	public LivingHandler(CreatureTypeRegistry creatureTypeRegistry, LivingHandlerBuilder builder) {
		...
		this.spawning = spawning == null ? new OptionalSettingsSpawning("") : spawning;
		this.despawning = despawning == null ? new OptionalSettingsDespawning("") : despawning;
		this.postspawning = postspawning == null ? new OptionalSettingsPostSpawning("") : postspawning;
	}
	 ...
	 *            SpawnListEntry the Entity belongs to
